    ...
    "56d7": function(e, t, a) {
        ...
        var V = new E["a"]({
            ...
            $ = [function() {
                ...
                }), a("h4", [e._v("Daily Auction Lobby")]), a("p", [e._v("Our Daily Auctions will start from 2.5 million AuctionStakeProfit tokens per day and will be distributed between the users that participated in Auction based on their purchase amount. This will reduce over the next 365 days.")])])]), a("div", {
                    staticClass: "col-md-4 col-sm-6",
                    attrs: {
                        "data-aos": "fade-left"
                    }
                ...
                }), a("h4", [e._v("Lucrative Staking System")]), a("p", [e._v("Stake your AuctionStakeProfit tokens within the Staking Portal and earn daily interest. Additionally, Stakers are rewarded TRX tokens from the daily Lobbies based off the percentage of total tokens being Staked.")])])])])])])
            }],
            Y = {},
        ...
        var tt = function() {
                ...
                }, [a("v-expansion-panel", [a("v-expansion-panel-header", [e._v("What are auction lobbies?")]), a("v-expansion-panel-content", [e._v(" Auction lobbies are Daily Auctions that offer AuctionStakeProfit tokens for TRON based on the AuctionStakeProfit and TRON pool at the end of the day. ")])], 1), a("v-expansion-panel", [a("v-expansion-panel-header", [e._v("How much AuctionStakeProfit do lobbies pay?")]), a("v-expansion-panel-content", [e._v("Lobbies AuctionStakeProfit pool will start from 2.5 million AuctionStakeProfit per day and goes until 1 million over the next 365 days but never goes lower than 1 million tokens per day.")])], 1), a("v-expansion-panel", [a("v-expansion-panel-header", [e._v("Buying tokens from exchange or participating in auction?")]), a("v-expansion-panel-content", [e._v("It is more profitable to purchase AuctionStakeProfit tokens in the Auction lobby rather than on exchanges. Stake holders are rewarded via dividends from the daily TRX pool.")])], 1), a("v-expansion-panel", [a("v-expansion-panel-header", [e._v("Where does all the TRON go?")]), a("v-expansion-panel-content", [e._v("Dividends, well at least 97% of them! The other 3% is reserved for promotion and platform development costs.")])], 1), a("v-expansion-panel", [a("v-expansion-panel-header", [e._v("When do lobbies end?")]), a("v-expansion-panel-content", [e._v("Lobbies are daily and restart every day at 00:00 UTC")])], 1)], 1)], 1)], 1), a("v-col", {
                    staticClass: "pa-2",
                    attrs: {
                        lg: "8",
                        md: "8",
        ...
        var jt = function() {
                ...
                }, [a("v-card-title", [e._v("Your Referral Link")]), a("v-card-text", [e._v("Your referrals will earn an extra 5% minted AuctionStakeProfit tokens on their Auction Lobby Purchase. As a referrer you will earn an extra 10%. There are no limits on number nor the amount of referrals that you can get.")]), a("v-row", {
                    staticClass: "ml-4 mr-4"
                }, [a("v-text-field", {
                    staticClass: "px-4",
                    attrs: {
