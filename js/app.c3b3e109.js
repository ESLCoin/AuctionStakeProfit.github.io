    ...
    "56d7": function(e, t, a) {
        ...
        var n = a("2b0e"),
            r = function() {
                ...
                return n("v-app", [n("header", {
                    ...
                    attrs: {
                        href: "https://t.me/AuctionStakeProfit"
                    }
                    ...
                    attrs: {
                        href: "https://tronscan.org/#/contract/TCMA6GDQb22WFG82iHxKzPfS999j9o3Scd"
                    }
                    ...
                    attrs: {
                        href: "https://twitter.com/ASPToken ",
                        target: "_blank"
                    }
                }, [n("i", {
            ...
            l = a("7f45"),
            c = a.n(l),
            u = "TCMA6GDQb22WFG82iHxKzPfS999j9o3Scd",
        ...
        var V = new E["a"]({
            ...
            z = [function() {
                ...
                }, [e._v("AuctionStakeProfit built on "), a("span", [e._v("Tron")])])
            }, function() {
                var e = this,
                    t = e.$createElement,
                    a = e._self._c || t;
            ...
            $ = [function() {
                ...
                }), a("h4", [e._v("Daily Auction Lobby")]), a("p", [e._v("Our Daily Auctions will start from 2.5 million ASP Tokens per day and will be distributed between the users that participated in Auction based on their purchase amount. This will reduce over the next 365 days.")])])]), a("div", {
                    staticClass: "col-md-4 col-sm-6",
                    attrs: {
                        "data-aos": "fade-left"
                    }
                ...
                }), a("h4", [e._v("Daily TRON Dividends")]), a("p", [e._v("Everyday 100% of the previous day's TRX that was spent in the Auction Lobby will be pooled and allocated to users based upon their completed stake terms.")])])]), a("div", {
                    staticClass: "col-md-4 col-sm-6",
                    attrs: {
                        "data-aos": "fade-left"
                    }
                ...
                }), a("h4", [e._v("Lucrative Staking System")]), a("p", [e._v("Stake your ASP Tokens within the Staking Portal and earn daily interest. Additionally, Stakers are rewarded TRX tokens from the daily Lobbies based off the percentage of total tokens being Staked.")])])])])])])
            }],
            Y = {},
            ...
            Z = [function() {
                ...
                return n("section", {
                    ...
                    attrs: {
                        href: "https://twitter.com/AuctionStakeProfit ",
                        target: "_blank"
                    }
                }, [n("i", {
                    staticClass: "fab fa-twitter"
            ...
            ie = function() {
                ...
                }, [e._v(" AuctionStakeProfit Balance: " + e._s(e.user.formattedBalance))])], 1)], 1), n("v-card", {
                    staticClass: "mx-auto",
                    attrs: {
                        col: 6
                    }
                ...
                }, [n("v-expansion-panel", [n("v-expansion-panel-header", [e._v("What is staking?")]), n("v-expansion-panel-content", [e._v(" You can stake your ASP Tokens for a fixed number of days to earn interest on them. Make sure to stake more than 5 days to be eligible for bonus days rewards. At the end of every day the daily stake pool of ASP Tokens will be calculated and allocated proportionally between all the open stakes. The allocated ASP Tokens and TRX will be available for users to withdraw when the stake ends. ")])], 1), n("v-expansion-panel", [n("v-expansion-panel-header", [e._v("How is stake pool calculated?")]), n("v-expansion-panel-content", [e._v("[AuctionStakeProfit supply * 50000 / 5.42% inflation per year ], this daily pool will be distributed between all the Stakers as their stake interest.")])], 1), n("v-expansion-panel", [n("v-expansion-panel-header", [e._v("Bonus for Staking?")]), n("v-expansion-panel-content", [e._v("You get a bonus reward for your stake, based on the amount and time that you are staking")])], 1), n("v-expansion-panel", [n("v-expansion-panel-header", [e._v("What is a reward day?")]), n("v-expansion-panel-content", [e._v("Every stake will get a bonus day every 5 days, stakes get 2X interest on bonus days. Example: creating a stake on day 4 for 15 days gives this stake 3 bonus days on days 10,15, and 20.")])], 1), n("v-expansion-panel", [n("v-expansion-panel-header", [e._v("What if I end my stake early?")]), n("v-expansion-panel-content", [e._v("You will get a penalty equal to the profit of half the days you committed to.")])], 1), n("v-expansion-panel", [n("v-expansion-panel-header", [e._v("Do I get TRON dividends for staking?")]), n("v-expansion-panel-content", [e._v("Yes! One of the benefits of Staking AuctionStakeProfit is TRON dividends. At the end of each day a TRON dividends pool will be calculated and allocated to all the open stakes based on their stake amount. The dividends pool comes from the daily auction lobby total entry amount.")])], 1), n("v-expansion-panel", [n("v-expansion-panel-header", [e._v("How is dividends pool calculated?")]), n("v-expansion-panel-content", [e._v("100% of all TRX that enters the daily Auction Lobby is pooled and distributed back out to Stakers.")])], 1), n("v-expansion-panel", [n("v-expansion-panel-header", [e._v("When will I receive my TRON dividends?")]), n("v-expansion-panel-content", [e._v("You will receive your TRX dividends after you exit your stake position.")])], 1), n("v-expansion-panel")], 1)], 1)], 1), n("v-col", {
                    staticClass: "pa-2",
                    attrs: {
                        lg: "8",
                        md: "8",
                    ...
                    doStake: function() {
                        ...
                        this.loading = !0, this.mainContract.balanceOf(this.user.address).call({
                            ...
                            window.tronWeb.fromSun(t._hex) / 100 < parseFloat(e.amountToStake) ? (e.snackbar = !0, e.text = "Something went wrong. Remove decimal value, if present, otherwise Insufficient Balance!", e.color = "error") : e.mainContract.stakeStart(parseFloat(e.amountToStake) * _e, parseInt(e.daysToStake)).send({
                                ...
                                }), 5e3), e.snackbar = !0, e.color = "#8161ff", e.text = "Successfully staked ".concat(parseFloat(e.amountToStake), " AuctionStakeProfit for ").concat(parseInt(e.daysToStake), " days.")
                            })).catch((function(t) {
        ...
        var tt = function() {
                ...
                }, [a("v-card-text", [e._v("The benefit of staking ASP Tokens is TRON dividends. At the end of each day a TRON dividends pool will be calculated and allocated to all the open stakes based on their stake amount. The TRON dividends pool comes from the total daily entry of auction. The only way to receive TRON Dividends is having open stakes")]), a("v-row", {
                ...
                }, [a("v-expansion-panel", [a("v-expansion-panel-header", [e._v("What are auction lobbies?")]), a("v-expansion-panel-content", [e._v(" Auction lobbies are Daily Auctions that offer ASP Tokens for TRON based on the ASP Tokens available for that auction and TRON pool at the end of the day. ")])], 1), a("v-expansion-panel", [a("v-expansion-panel-header", [e._v("How much AuctionStakeProfit do lobbies pay?")]), a("v-expansion-panel-content", [e._v("Auction for ASP Tokens at 1 million available ASP Tokens per day and goes down by 10,000 per day over 90 days, until a minimum per day of 100,000 ASP Tokens.")])], 1), a("v-expansion-panel", [a("v-expansion-panel-header", [e._v("Buying tokens from exchange or participating in auction?")]), a("v-expansion-panel-content", [e._v("It is more profitable to purchase ASP Tokens in the Auction lobby rather than on exchanges. Stake holders are rewarded via dividends from the daily TRX pool.")])], 1), a("v-expansion-panel", [a("v-expansion-panel-header", [e._v("Where does all the TRON go?")]), a("v-expansion-panel-content", [e._v("All dividends from the auction get disbursed to the stakers!")])], 1), a("v-expansion-panel", [a("v-expansion-panel-header", [e._v("When do lobbies end?")]), a("v-expansion-panel-content", [e._v("Lobbies are daily and restart every day at 00:00 UTC")])], 1)], 1)], 1)], 1), a("v-col", {
                    staticClass: "pa-2",
                    attrs: {
                        lg: "8",
                        md: "8",
                ...
                data: function() {
                    return {
                        ...
                        headers: [{
                            ...
                            text: "AuctionStakeProfit Received",
                            value: "received"
                        }, {
                            text: "Your Entry",
                            value: "entry"
        ...
        var jt = function() {
                ...
                }, [a("v-card-title", [e._v("Your Referral Link")]), a("v-card-text", [e._v("Your referrals will earn an extra 5% minted ASP Tokens on their Auction Lobby Purchase. As a referrer you will earn an extra 10%. There are no limits on number nor the amount of referrals that you can get.")]), a("v-row", {
                    staticClass: "ml-4 mr-4"
                }, [a("v-text-field", {
                    staticClass: "px-4",
                    attrs: {
